...
/**
 * Wires SQLite stores, auth, `/v1/*` proxy, and REST routes. Kept out of `server.ts` so the
 * entrypoint stays a one-liner and route modules remain the home for HTTP handlers.
 */
